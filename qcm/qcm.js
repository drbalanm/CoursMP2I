...
{
	if (region.ce.aj === region.cv.aj)
	{
		return 'on line ' + region.ce.aj;
	}
	return 'on lines ' + region.ce.aj + ' through ' + region.cv.aj;
}
...
function _Markdown_formatOptions(options)
{
	...
	{
		if (!lang && $elm$core$Maybe$isJust(options.cs))
		{
			lang = options.cs.a;
		}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cx: fragment, cz: host, cM: path, cO: port_, cS: protocol, cT: query};
	});
...
var $author$project$Qcm$QCM = F4(
	function (nbQuestions, niveauCandidat, note, range) {
		return {V: nbQuestions, W: niveauCandidat, a9: note, bB: range};
	});
var $author$project$Qcm$ShowHistogram = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Qcm$binomM = F3(
	function (mem, n, k) {
		if (!n) {
			return (!k) ? _Utils_Tuple2(mem, 1) : _Utils_Tuple2(mem, 0);
		} else {
			var _v1 = A2(
				$elm$core$Dict$get,
				_Utils_Tuple2(n, k),
			...
			if (!_v1.$) {
				var b = _v1.a;
				return _Utils_Tuple2(mem, b);
			} else {
				var _v2 = A3($author$project$Qcm$binomM, mem, n - 1, k - 1);
				var b2 = _v2.b;
				var _v3 = A3($author$project$Qcm$binomM, mem, n - 1, k);
				var m1 = _v3.a;
				var b1 = _v3.b;
...
var $author$project$Qcm$binom = F2(
	function (n, k) {
		return A3(
			$author$project$Qcm$binomM,
...
var $author$project$Qcm$computeBinomial = F4(
	function (t, k, n, s) {
		return (A2($author$project$Qcm$binom, t, s) * $elm$core$List$product(
			A2($elm$core$List$repeat, s, (n + k) / (2 * n)))) * $elm$core$List$product(
			A2($elm$core$List$repeat, t - s, (n - k) / (2 * n)));
	});
var $elm$core$List$sum = function (numbers) {
	return A3($elm$core$List$foldl, $elm$core$Basics$add, 0, numbers);
};
var $author$project$Qcm$computePr = F5(
	function (precision, nbQ, k, n, note) {
		var x = A4($author$project$Qcm$computeBinomial, nbQ, k, n, note);
		var norm = $elm$core$List$sum(
			A2(
				$elm$core$List$map,
				function (j) {
					return A4($author$project$Qcm$computeBinomial, nbQ, j, n, note);
				},
				A2($elm$core$List$range, 0, precision)));
		return x / norm;
	});
...
var $author$project$Qcm$encodeHP = F3(
	function (nbQ, note, precision) {
				...
				[
					...
					A2(
						...
						A2(
							$elm$core$List$map,
							function (k) {
								return A5($author$project$Qcm$computePr, precision, nbQ, k, precision, note);
							},
							A2($elm$core$List$range, 0, precision)))),
					_Utils_Tuple2(
					'type',
...
var $author$project$Qcm$encodePlot = function (vs) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'data',
				A2($elm$json$Json$Encode$list, $elm$core$Basics$identity, vs))
			]));
};
...
var $author$project$Qcm$histogram = function (notes) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (n, d) {
				return A3(
					...
					function (x) {
						if (x.$ === 1) {
							...
							var xx = x.a;
							return $elm$core$Maybe$Just(xx + 1);
						}
					},
					d);
			}),
...
var $author$project$Qcm$nbSimulations = 5000;
...
var $author$project$Qcm$bernoulli = function (p) {
	return A2(
		$elm$random$Random$map,
		function (x) {
			return (_Utils_cmp(x, p) < 1) ? 1 : 0;
		},
...
var $author$project$Qcm$oneAnswer = function (p) {
	return A2(
		$elm$random$Random$andThen,
		function (b) {
			return (b === 1) ? $elm$random$Random$constant(1) : $author$project$Qcm$bernoulli(0.5);
		},
		$author$project$Qcm$bernoulli(p));
};
var $author$project$Qcm$simulation = F2(
	function (n, p) {
		return A2(
			$elm$random$Random$map,
			$elm$core$List$sum,
			A2(
				...
				n,
				$author$project$Qcm$oneAnswer(p)));
	});
var $author$project$Qcm$lotSimulations = F2(
	function (n, p) {
		return A2(
			$elm$random$Random$map,
			$author$project$Qcm$histogram,
			A2(
				$elm$random$Random$list,
				$author$project$Qcm$nbSimulations,
				A2($author$project$Qcm$simulation, n, p)));
	});
var $author$project$Qcm$renderPlot2 = _Platform_outgoingPort('renderPlot2', $elm$core$Basics$identity);
var $author$project$Qcm$init = function (_v0) {
	return _Utils_Tuple2(
		{
			a: A4($author$project$Qcm$QCM, 20, 0.5, 13, 100),
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					$author$project$Qcm$ShowHistogram,
					A2($author$project$Qcm$lotSimulations, 20, 0.5)),
					$author$project$Qcm$renderPlot2(
					$author$project$Qcm$encodePlot(
						_List_fromArray(
							[
								A3($author$project$Qcm$encodeHP, 20, 13, 100)
							])))
				])));
};
...
var $author$project$Qcm$encodeH = function (d) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				A2(
					...
					function (_v0) {
						var a = _v0.a;
						return $elm$json$Json$Encode$int(a);
					},
...
var $author$project$Qcm$renderPlot = _Platform_outgoingPort('renderPlot', $elm$core$Basics$identity);
var $elm$core$String$toFloat = _String_toFloat;
var $author$project$Qcm$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var n = msg.a;
				var _v1 = $elm$core$String$toInt(n);
				if (!_v1.$) {
					var nb = _v1.a;
					var qcm = model.a;
					return _Utils_Tuple2(
			...
			case 1:
				var p = msg.a;
				var _v2 = $elm$core$String$toFloat(p);
				if (!_v2.$) {
					var pr = _v2.a;
					var qcm = model.a;
					return _Utils_Tuple2(
			...
			case 4:
				var n = msg.a;
				var _v3 = $elm$core$String$toInt(n);
				if (!_v3.$) {
					var note = _v3.a;
					var qcm = model.a;
					return _Utils_Tuple2(
			...
			case 2:
				return _Utils_Tuple2(
					...
					A2(
						$elm$random$Random$generate,
						$author$project$Qcm$ShowHistogram,
						A2($author$project$Qcm$lotSimulations, model.a.V, model.a.W)));
			case 3:
				var d = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{cd: d}),
					$author$project$Qcm$renderPlot(
						$author$project$Qcm$encodePlot(
							_List_fromArray(
								[
									$author$project$Qcm$encodeH(d)
								]))));
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Qcm$renderPlot2(
						$author$project$Qcm$encodePlot(
							_List_fromArray(
								[
									A3($author$project$Qcm$encodeHP, model.a.V, model.a.a9, model.a.bB)
								]))));
		}
	});
...
var $author$project$Qcm$distribution1 = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$id('distribution')
		]),
	_List_Nil);
var $author$project$Qcm$distribution2 = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$id('distribution2')
		]),
	_List_Nil);
var $author$project$Qcm$ChangeNbQuestions = function (a) {
	return {$: 0, a: a};
};
var $author$project$Qcm$ChangeNiveau = function (a) {
	return {$: 1, a: a};
};
var $author$project$Qcm$Simulate = {$: 2};
...
var $rundis$elm_bootstrap$Bootstrap$Internal$Button$defaultOptions = {aJ: _List_Nil, aM: false, w: $elm$core$Maybe$Nothing, aW: false, bI: $elm$core$Maybe$Nothing};
...
var $rundis$elm_bootstrap$Bootstrap$Internal$Button$buttonAttributes = function (modifiers) {
	...
	return _Utils_ap(
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('btn-block', options.aM),
		...
		_Utils_ap(
			function () {
				var _v0 = A2($elm$core$Maybe$andThen, $rundis$elm_bootstrap$Bootstrap$General$Internal$screenSizeOption, options.bI);
				if (!_v0.$) {
					var s = _v0.a;
					return _List_fromArray(
						[
...
var $rundis$elm_bootstrap$Bootstrap$Form$col = F2(
	function (options, children) {
		return {cp: children, cu: $elm$html$Html$div, b5: options};
	});
...
var $rundis$elm_bootstrap$Bootstrap$Form$applyModifier = F2(
	function (modifier, options) {
		...
		return _Utils_update(
			options,
			{
				aJ: _Utils_ap(options.aJ, value)
			});
	});
var $rundis$elm_bootstrap$Bootstrap$Form$defaultOptions = {aJ: _List_Nil};
		...
		switch (modifier.$) {
			...
			case 6:
				...
				return _Utils_update(
					options,
					{
						bT: $elm$core$Maybe$Just(validation_)
					});
			case 8:
				var val = modifier.a;
				return _Utils_update(
			...
			default:
				...
				return _Utils_update(
					options,
					{
						aJ: _Utils_ap(options.aJ, attrs_)
					});
		}
	});
var $rundis$elm_bootstrap$Bootstrap$Form$Input$Text = 0;
var $rundis$elm_bootstrap$Bootstrap$Form$Input$defaultOptions = {aJ: _List_Nil, aW: false, ae: $elm$core$Maybe$Nothing, bj: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing, an: false, bC: false, bI: $elm$core$Maybe$Nothing, ap: 0, bT: $elm$core$Maybe$Nothing, t: $elm$core$Maybe$Nothing};
...
var $rundis$elm_bootstrap$Bootstrap$Form$Input$toAttributes = function (modifiers) {
	...
	return _Utils_ap(
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class(
				options.an ? 'form-control-plaintext' : 'form-control'),
				$elm$html$Html$Attributes$disabled(options.aW),
				$elm$html$Html$Attributes$readonly(options.bC || options.an),
				$rundis$elm_bootstrap$Bootstrap$Form$Input$typeAttribute(options.ap)
			]),
		_Utils_ap(
			A2(
				...
				_List_fromArray(
					[
						A2($elm$core$Maybe$map, $elm$html$Html$Attributes$id, options.ae),
						A2($elm$core$Maybe$andThen, $rundis$elm_bootstrap$Bootstrap$Form$Input$sizeAttribute, options.bI),
						...
						A2($elm$core$Maybe$map, $rundis$elm_bootstrap$Bootstrap$Form$Input$validationAttribute, options.bT)
					])),
			options.aJ));
};
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$Width = F2(
	function (screenSize, columnCount) {
		return {cq: columnCount, cY: screenSize};
	});
		...
		switch (_v0) {
			...
			case 1:
				return _Utils_update(
					options,
					{
						aE: $elm$core$Maybe$Just(align_)
					});
			case 2:
				return _Utils_update(
					options,
					{
						aD: $elm$core$Maybe$Just(align_)
					});
			case 3:
				return _Utils_update(
					options,
					{
						aC: $elm$core$Maybe$Just(align_)
					});
			default:
				return _Utils_update(
					options,
		...
		switch (_v0) {
			...
			case 1:
				return _Utils_update(
					options,
					{
						av: $elm$core$Maybe$Just(width_)
					});
			case 2:
				return _Utils_update(
					options,
					{
						au: $elm$core$Maybe$Just(width_)
					});
			case 3:
				return _Utils_update(
					options,
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$colWidthClass = function (_v0) {
	var screenSize = _v0.cY;
	var columnCount = _v0.cq;
	return $elm$html$Html$Attributes$class(
		'col' + (A2(
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultColOptions = {aC: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aJ: _List_Nil, ba: $elm$core$Maybe$Nothing, bb: $elm$core$Maybe$Nothing, bc: $elm$core$Maybe$Nothing, be: $elm$core$Maybe$Nothing, bf: $elm$core$Maybe$Nothing, bl: $elm$core$Maybe$Nothing, bm: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bo: $elm$core$Maybe$Nothing, bp: $elm$core$Maybe$Nothing, br: $elm$core$Maybe$Nothing, bs: $elm$core$Maybe$Nothing, bt: $elm$core$Maybe$Nothing, bu: $elm$core$Maybe$Nothing, bv: $elm$core$Maybe$Nothing, bw: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, by: $elm$core$Maybe$Nothing, bz: $elm$core$Maybe$Nothing, bA: $elm$core$Maybe$Nothing, bK: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing, au: $elm$core$Maybe$Nothing, av: $elm$core$Maybe$Nothing, aw: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing};
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$colAttributes = function (modifiers) {
	...
	var shouldAddDefaultXs = !$elm$core$List$length(
		A2(
			...
			$elm$core$Basics$identity,
			_List_fromArray(
				[options.ax, options.av, options.au, options.at, options.aw])));
	return _Utils_ap(
		$rundis$elm_bootstrap$Bootstrap$Grid$Internal$colWidthsToAttributes(
			_List_fromArray(
				[
					shouldAddDefaultXs ? $elm$core$Maybe$Just(
					A2($rundis$elm_bootstrap$Bootstrap$Grid$Internal$Width, 0, 0)) : options.ax,
					options.av,
					options.au,
					options.at,
					options.aw
					...
					_Utils_ap(
						...
						_Utils_ap(
							A2(
								...
								'align-self-',
								_List_fromArray(
									[options.aG, options.aE, options.aD, options.aC, options.aF])),
							_Utils_ap(
								function () {
									var _v0 = options.bK;
									if (!_v0.$) {
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultRowOptions = {aJ: _List_Nil, aY: $elm$core$Maybe$Nothing, aZ: $elm$core$Maybe$Nothing, a_: $elm$core$Maybe$Nothing, a$: $elm$core$Maybe$Nothing, a0: $elm$core$Maybe$Nothing, bO: $elm$core$Maybe$Nothing, bP: $elm$core$Maybe$Nothing, bQ: $elm$core$Maybe$Nothing, bR: $elm$core$Maybe$Nothing, bS: $elm$core$Maybe$Nothing};
...
var $author$project$Qcm$form1 = function (model) {
	return A2(
		...
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Nombre de questions')
											])),
										$rundis$elm_bootstrap$Bootstrap$Form$Input$text(
										_List_fromArray(
											[
												$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput($author$project$Qcm$ChangeNbQuestions),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Niveau du candidat')
											])),
										$rundis$elm_bootstrap$Bootstrap$Form$Input$number(
										_List_fromArray(
											[
												$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput($author$project$Qcm$ChangeNiveau),
												((model.a.W <= 1) && (model.a.W >= 0)) ? $rundis$elm_bootstrap$Bootstrap$Form$Input$success : $rundis$elm_bootstrap$Bootstrap$Form$Input$danger,
												$rundis$elm_bootstrap$Bootstrap$Form$Input$value(
												$elm$core$String$fromFloat(model.a.W))
											]))
									]))
							]))
					])),
				...
				_List_fromArray(
					[
						$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Qcm$Simulate),
						$rundis$elm_bootstrap$Bootstrap$Button$primary,
						$rundis$elm_bootstrap$Bootstrap$Button$block
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Lancer les simulations')
					]))
			]));
};
var $author$project$Qcm$ChangeNote = function (a) {
	return {$: 4, a: a};
};
var $author$project$Qcm$ChangeRange = function (a) {
	return {$: 6, a: a};
};
var $author$project$Qcm$ComputeP = {$: 5};
var $author$project$Qcm$form2 = function (model) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Form$form,
		_List_Nil,
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Note du candidat')
											])),
										$rundis$elm_bootstrap$Bootstrap$Form$Input$number(
										_List_fromArray(
											[
												$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput($author$project$Qcm$ChangeNote),
												$rundis$elm_bootstrap$Bootstrap$Form$Input$value(
												$elm$core$String$fromInt(model.a.a9))
											]))
									]))
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Nombre de valeurs que peur prendre p')
											])),
										$rundis$elm_bootstrap$Bootstrap$Form$Input$number(
										_List_fromArray(
											[
												$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput($author$project$Qcm$ChangeRange),
												$rundis$elm_bootstrap$Bootstrap$Form$Input$value(
												$elm$core$String$fromInt(model.a.bB))
											]))
									]))
							]))
					])),
				...
				_List_fromArray(
					[
						$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Qcm$ComputeP),
						$rundis$elm_bootstrap$Bootstrap$Button$primary,
						$rundis$elm_bootstrap$Bootstrap$Button$block
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Afficher la distribution de p')
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Qcm$description1,
				$author$project$Qcm$form1(model),
				$author$project$Qcm$distribution1,
				$author$project$Qcm$description2,
				$author$project$Qcm$form2(model),
				$author$project$Qcm$distribution2
			]));
};
var $author$project$Qcm$main = $elm$browser$Browser$element(
	{
		dp: $author$project$Qcm$init,
		dz: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		dC: $author$project$Qcm$update,
		dD: $author$project$Qcm$view
	});
